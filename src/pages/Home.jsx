  ...
  return (
    <>
      ...
      <section className="bg-gray-950 py-10">
        <div className="max-w-7xl mx-auto px-10 sm:px-6 px-4">
          <h1 className="text-white font-bold text-3xl md:text-2xl sm:text-xl mb-7">
            Top Categories
          </h1>

          <div className="bg-transparent grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <Card
